      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Ready to start your next project with us? Contact us today and let's discuss how we can help your business grow.
          </p>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@dina-business.com</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-300 transform hover:scale-105 disabled:transform-none"
              >
                {isSubmitting ? (
